...
export default function Book() {
  ...
  const desktop = windowSize >= 769;
  const tablet = windowSize >= 451 && windowSize <= 768;
  const mobile = windowSize <= 450;
      ...
      {desktop && (
        <BookContainer>
          ...
          <BlockB>              
            ...
            <ActionButton type="action" text={`Contact ${bookOwner}`} />
          </BlockB>
        </BookContainer>
      )}
